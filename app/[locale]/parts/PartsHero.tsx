  ...
  return (
    <section className="relative h-[90vh] w-full overflow-hidden bg-black text-white">
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        <div className="reveal-hidden reveal-fade-right stagger-3 absolute bottom-6 hidden w-full max-w-5xl justify-between border-t border-white/10 pt-6 lg:flex">
