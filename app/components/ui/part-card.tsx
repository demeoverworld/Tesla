	...
	return (
		<>
			<div
				...
				className={cn(
					"flex w-full max-w-[16.5rem] flex-col items-center overflow-hidden rounded-none border border-slate-200 bg-white px-3 py-3 text-slate-900 shadow-[0_18px_40px_rgba(0,0,0,0.08)] cursor-pointer"
				)}
			>
				...
				<img
					...
					alt={product.name}
					className="h-32 w-full rounded-none border border-slate-200 bg-slate-100 object-cover"
