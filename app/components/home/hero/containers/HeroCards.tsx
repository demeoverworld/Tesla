...
export function HeroCards({ locale }: HeroCardsProps) {
          ...
          {cards.map((card, index) => (
            ...
            >
              <div className="flex min-w-0 flex-1 flex-col gap-4">
                ...
                <Button
                  asChild
                  className="group relative isolate w-fit overflow-hidden border border-red-600 bg-red-600 px-6 py-2.5 text-white transition-colors duration-300 before:absolute before:inset-0 before:-z-10 before:origin-center before:scale-x-0 before:rounded-[inherit] before:bg-white before:transition-transform before:duration-500 before:ease-[cubic-bezier(0.16,1,0.3,1)] hover:text-red-600 hover:before:scale-x-100 animate-[fadeInUp_0.6s_ease-out_forwards]"
                >
                  <Link href={card.href}>
